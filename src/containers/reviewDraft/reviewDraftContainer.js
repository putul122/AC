...
export function mapStateToProps (state, props) {
  return {
    ...
    review: state.reviewDraftReducer.review,
    ...
    componentTypeComponents: state.reviewDraftReducer.componentTypeComponents,
    updateReviewResponse: state.reviewDraftReducer.updateReviewResponse,
    selectedCheckItems: state.reviewDraftReducer.selectedCheckItems,
